import { LOAD_PROPOSALS, LOAD_PROPOSALS_FAILURE, LOAD_PROPOSALS_SUCCESS,
         ...
         UPDATE_PROPOSAL, UPDATE_PROPOSAL_FAILURE, UPDATE_PROPOSAL_SUCCESS, VOTE_PROPOSAL_FAILURE, VOTE_PROPOSAL_SUCCESS, UNLIKE_PROPOSAL_SUCCESS, UNLIKE_PROPOSAL_FAILURE } from "../actions"
...
const proposalsReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case LOAD_PROPOSALS_FAILURE || DELETE_PROPOSAL_FAILURE || CREATE_PROPOSAL_FAILURE || UPDATE_PROPOSAL_FAILURE || VOTE_PROPOSAL_FAILURE || VOTE_PROPOSAL_SUCCESS || UNLIKE_PROPOSAL_SUCCESS || UNLIKE_PROPOSAL_FAILURE:
            return {
                isFetching: false,
                ...state
            }
